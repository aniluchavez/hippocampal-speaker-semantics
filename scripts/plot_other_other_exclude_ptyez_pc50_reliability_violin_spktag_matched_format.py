...
BERT bidirectional-max-context embeddings WITH speaker tags, PC50, patient
...
Source data: SemanticGLM/other_other_rcross_reliability_bert_spktag_pc50/
             */*/hippocampus_other_other_reliability_detail.csv

Output: figures/14_other_other_exclude_ptyez_pc50_reliability_violin_spktag_matched_format.pdf
"""
...
DATA_DIR = Path("/scratch/aniluchavez/ConvoDATAS/SemanticGLM/other_other_rcross_reliability_bert_spktag_pc50")
...
ax.set_title(
    "Hippocampal beta reliability between external speakers, BERT bidirectional max context + speaker tag, PC50, PTYEZ excluded",
    fontsize=6.5, fontweight="bold",
)
ax.spines[["top", "right"]].set_visible(False)

out_pdf = FIG_DIR / "14_other_other_exclude_ptyez_pc50_reliability_violin_spktag_matched_format.pdf"
out_png = FIG_DIR / "14_other_other_exclude_ptyez_pc50_reliability_violin_spktag_matched_format.png"
out_svg = FIG_DIR / "14_other_other_exclude_ptyez_pc50_reliability_violin_spktag_matched_format.svg"
fig.savefig(out_pdf)
