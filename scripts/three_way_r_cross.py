...
Same model/window/PC as speaker_pair_r_cross.py and self_other_r_cross_pc30.py
...
def fit_pair(patient, X_pca, masks, Ys, spkA, spkB):
    ...
    out_path = os.path.join(RESULTS_DIR, f"threeway_rcross_{patient}_{pair_tag}_bert_L12_pc30.pkl")
...
def main():
    ...
    out_csv = os.path.join(RESULTS_DIR, "threeway_rcross_bert_L12_pc30_summary.csv")
