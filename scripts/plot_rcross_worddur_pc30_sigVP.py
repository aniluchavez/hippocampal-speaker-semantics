...
self or other condition, using worddur VP (pc30, xcirc + block CV + sym_perm).

Output: figures/10_brackets_worddur_pc30_sigVP_L36.pdf
"""
...
VP_DIR = VPR_DIR / "gpt2-xl_ctx200_worddur_xcirc_symperm" / "pc30"
...
ax.set_title(
    ...
    f"VP: worddur pc30, xcirc+block+sym_perm, L36\n"
    f"Reliability: bestfixed window, GPT-2 XL L45\n"
    f"n={n_neurons} neurons, {n_patients} patients  |  p_perm<0.05 & unique_sem>0 (self or other)",
    fontsize=10, fontweight="bold",
)
ax.spines[["top", "right"]].set_visible(False)

out_pdf = FIG_DIR / "10_brackets_worddur_pc30_sigVP_L36.pdf"
out_png = FIG_DIR / "10_brackets_worddur_pc30_sigVP_L36.png"
out_svg = FIG_DIR / "10_brackets_worddur_pc30_sigVP_L36.svg"
