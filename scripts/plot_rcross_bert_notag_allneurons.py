...
(no significance/VP filtering), using BERT no-tag embeddings
(bert-base, ctx200, bestfixed window, pc50, L12). No-tag counterpart of
plot_rcross_bert_spktag_allneurons.py.

Output: figures/11_brackets_bert_notag_allneurons_L12.pdf

No variance-partitioning run exists yet for this embedding, so unlike
plot_rcross_bert_pc30_sigVP.py this does not filter to unique-semantic
...
out_pdf = FIG_DIR / "11_brackets_bert_notag_allneurons_L12.pdf"
out_png = FIG_DIR / "11_brackets_bert_notag_allneurons_L12.png"
out_svg = FIG_DIR / "11_brackets_bert_notag_allneurons_L12.svg"
fig.savefig(out_pdf)
