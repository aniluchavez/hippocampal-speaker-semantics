...
BERT bidirectional-max-context embeddings, PC50 (matched to the self/other
reliability pipeline's PC count), patient PTYEZ excluded, 1000-draw
permutation null. Bracket-violin format matched to the self/other
reliability figures (plot_rcross_bert_pc30_sigVP.py /
plot_rcross_bert_spktag_allneurons.py).

Source data: SemanticGLM/other_other_rcross_reliability_bert_pc50/
             */*/hippocampus_other_other_reliability_detail.csv

Output: figures/13_other_other_exclude_ptyez_pc50_reliability_violin_matched_format.pdf
"""
...
DATA_DIR = Path("/scratch/aniluchavez/ConvoDATAS/SemanticGLM/other_other_rcross_reliability_bert_pc50")
...
ax.set_title(
    "Hippocampal beta reliability between external speakers, BERT bidirectional max context, PC50, PTYEZ excluded",
    fontsize=6.5, fontweight="bold",
)
ax.spines[["top", "right"]].set_visible(False)

out_pdf = FIG_DIR / "13_other_other_exclude_ptyez_pc50_reliability_violin_matched_format.pdf"
out_png = FIG_DIR / "13_other_other_exclude_ptyez_pc50_reliability_violin_matched_format.png"
out_svg = FIG_DIR / "13_other_other_exclude_ptyez_pc50_reliability_violin_matched_format.svg"
fig.savefig(out_pdf)
