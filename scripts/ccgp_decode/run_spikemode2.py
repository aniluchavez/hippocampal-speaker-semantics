...
from .io_spikemode2 import load_multi_patient_ccgp_inputs_word_order as load_many
...
def load_and_run_ccgp_models_multi_patient_parallel(
    *,
    patient_tags,
    region,
    ...
    from io_spikemode2 import load_multi_patient_ccgp_inputs_word_order

    load_kwargs = {} if load_kwargs is None else dict(load_kwargs)
    run_kwargs = {} if run_kwargs is None else dict(run_kwargs)

    data_dict = load_multi_patient_ccgp_inputs_word_order(
        patient_tags=patient_tags,
        region=region,
        region_ranges_by_patient=region_ranges_by_patient,
    ...
    return run_ccgp_models_multi_patient_parallel(
        data_dict=data_dict,
