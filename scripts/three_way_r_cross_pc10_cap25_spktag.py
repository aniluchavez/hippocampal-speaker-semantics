...
def fit_pair(patient, X_pca, masks, Ys, spkA, spkB):
    ...
    out_path = os.path.join(RESULTS_DIR, f"threeway_rcross_cap25_spktag_{patient}_{pair_tag}_bert_L12_pc10.pkl")
...
def main():
    ...
    out_csv = os.path.join(RESULTS_DIR, "threeway_rcross_cap25_spktag_bert_L12_pc10_summary.csv")
